...
public class SecondMqttSender implements Runnable {
    ...
    public void startSender() {
        ...
        String clientId = "second_sender"; // Client-ID
        String topic = "sensoren/sensor2"; // MQTT-Topic
        ...
        try {
            ...
            while (true) {
                ...
                // 1 Sekunde warten vor der nächsten Veröffentlichung
                Thread.sleep(1000);
            }
